...
/**
 * Utility class to find classes within the class path but outside of jar files.
 * Inner and anonymous classes are not being considered in the first place.
 * 
 * It's a variation of ClassPathTestCollector in JUnit 3.8.1
 */
public class ClasspathClassesFinder {
	...
	public ClasspathClassesFinder(ClassTester tester) {
		this.tester = tester;
	}

	public List<Class<?>> find() {
		String classPath = System.getProperty("java.class.path");
		return findClassesInClasspath(classPath);
	}
